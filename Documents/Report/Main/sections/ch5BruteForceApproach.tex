...
Although optimization is not the aim of this section, the previous formula would require passing the data twice: first to compute the mean of cosine and VTEC and second to compute the coefficient itself. The formula can also be expressed as follows:
...
\subsection{Discarding outliers by fitting the data}

It is necessary to discard outliers as they are problematic when computing the mean of the VTEC and the correlation. This is done....
