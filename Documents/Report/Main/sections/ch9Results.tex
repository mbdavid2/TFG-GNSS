...
The algorithm is tested using data from dates when both Solar flares and flares from far-away stars took place.

We will divide in Sun and far cuz different: Sun hemisphere is discarded

\section{Sun}

\subsection{Used data sets}

Case 1 : The Halloween Solar Storm: X17.2 flare
Case 2:

We used this flare...bla bla bla

Explain experiment: we use best epoch, the total error is calculated as abs(...)

\section{Using all available data}

Use all IPP data without any filter
