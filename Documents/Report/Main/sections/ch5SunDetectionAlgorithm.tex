...
Altough this a brute force approach, we first wanted to detect a spike in the VTEC content throughout the day in a simple way. For this we inserted, for each epoch \footnote{In our data set the epochs ranged from 10.5 to 11.5, that it is, 10:30AM to 11:30AM with a sampling rate of 1/120 hours or 30 seconds} compute the mean VTEC of all IPPs and insert it into a priority queue using C++.
